...
cur = con.cursor()
print(cur.execute('select * from record') 
...
def popup():
        ...
        def add_record1():
                 ...
                 for i in range(0,1):
                    ...
                    A.append(b)
                 #try the above 
                 my_tree1.insert(parent='',index='end', text="", values=(name_box1.get(),score1.get()))
                 t1 = tuple(A)
                 entr = 'Insert into record(name,score) values(%s,%s)'
                 cur.execute(entr,t1)
                 #to clear the boxes
...
def admin():
        ...
        #define our coloumns
        my_tree['columns'] =("Name" ,"GAME SCORE")

        #Format our coloumns
        my_tree.column("#0",width=0,minwidth=25)
        my_tree.column("Name",anchor=W,width=140)
        my_tree.column("GAME SCORE",anchor=CENTER,width=140)
        ...
        def add_record():
            ...
            my_tree.insert(parent='',index='end',iid=count, text="", values=(name_box.get(),password.get(),game_score.get()))
            count +=1
            #to clear the boxes
        ...
        remove_all = Button(root,text="Remove all reocrds" ,command=remove_all)
