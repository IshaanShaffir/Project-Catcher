...
def admin():
        ...
        game_score.grid(row=1,column=2)
        ...
        my_tree.heading("GAME SCORE",text="GAME SCORE",anchor=W)
        data = [
            ["kurtis conner","idk",20],
            ["bo burnham","irreallydontcare",20],
            ["gonazalez","i don",20],
            ["drew gooden","blah blah",20],
        ]
        global count
        count = 0
        for record in data:
